...
[Astro 5.0 Crash Course](https://www.youtube.com/watch?v=eQXG75XirdE&t=308s) - YT vid.


[htmx](https://htmx.org/) - directly in HTML, using attributes.
...
[bitplatform](https://bitplatform.dev/demos) - Blazor component library: A complete E2E solution.
[Blazor Chatbot](https://www.reddit.com/r/Blazor/comments/1k5aapy/free_opensource_ai_chatbot_for_blazor_server_wasm/) - bitplatform features
[Windsurf](https://windsurf.com/) - AI IDE.
[PostHog](https://posthog.com/) - analyze, test, observe, and deploy new features.

[XXX](#) - XXX.

# Cloud Dev

[Azure](https://portal.azure.com/#home) - Azure Portal
[AWS](https://us-west-2.console.aws.amazon.com/console/home?nc2=h_ct&region=us-west-2&src=header-signin#) - AWS Console
